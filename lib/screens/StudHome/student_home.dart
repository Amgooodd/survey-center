...
class _StudentFormState extends State<StudentForm> {
      ...
      _surveys = snapshot.docs.where((doc) {
        ...
        if (requireExact) {
          ...
          if (surveyDeptsUpper.length == 2) {
            return studentGroupComponents.every((studentDept) =>
                surveyDeptsUpper.contains(studentDept));
          } else {
            return surveyDeptsUpper.any((surveyDept) =>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Home for Student", style: TextStyle(color: Colors.white)),
...
class _NotificationsDialogState extends State<NotificationsDialog> {
  ...
  children: [
    ...
    if (notification['title'] == 'Survey About to End' && deadline != null)
      Text(
    ...
    Text(
      ...
      style: const TextStyle(fontSize: 12, color: Colors.grey),
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () => widget.markNotificationAsRead(notification['id']),
                    ),
                  );
                },
              ),
